...
```
## Error in dev.off(): QuartzBitmap_Output - unable to open file './figure/histogram_of_total_daily_steps.png'
```
...
```
## Error in dev.off(): QuartzBitmap_Output - unable to open file '../figure/average_steps_per_interval.png'
```
